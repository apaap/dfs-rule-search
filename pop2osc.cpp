// pop2osc-rsrch.cpp Two cell oscillator search with restricted rule transitions allowed
// Transisions determined from 20gen of 2-cell p137 oscillator
#include <iostream>
#include <algorithm>
#include <string>
#include <fstream>
...
const int max_x = 20;
const int max_y = 20;
const int max_xy = 20; // max(max_x, max_y)
const int max_t = 5000;
const int number_of_transitions = 102;
const std::string output_filename = "osc-rsrch-20x20.csv";
const std::string log_filename = "log-rsrch";
